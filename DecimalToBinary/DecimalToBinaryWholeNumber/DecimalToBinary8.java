/*
*  filename: DecimalToBinary8.java
*  author: Connor Baker
*  version: 0.1a
...
public class DecimalToBinary8 {
  ...
  BigInteger decimal;
  BigInteger[] temp;
  final static BigInteger VALUEOFEIGHT = new BigInteger("8");
  ArrayList<String> binaryRepresentation = new ArrayList<>();
  Scanner grabber = new Scanner(System.in);

  final static String[] LUT = {"000","001","010","011",
                               "100","101","110","111"};
  ...
  public void decimalToBinary(BigInteger decimal) {
    ...
    temp = decimal.divideAndRemainder(VALUEOFEIGHT);
  ...
  public static void main(String[] args) {
    DecimalToBinary8 newConversion = new DecimalToBinary8();
  }
}
