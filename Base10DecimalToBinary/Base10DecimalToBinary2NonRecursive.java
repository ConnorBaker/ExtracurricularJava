/*
*  filename: Base10DecimalToBinary2NonRecursive.java
*  author: Connor Baker
*  version: 0.1a
...
public class Base10DecimalToBinary2NonRecursive {
  ...
  Base10DecimalToBinary2NonRecursive() {
    initialization();
    queryForAccuracy();
  ...
  public static void main(String[] args) {
    Base10DecimalToBinary2NonRecursive newConversion = new Base10DecimalToBinary2NonRecursive();
  }
}
