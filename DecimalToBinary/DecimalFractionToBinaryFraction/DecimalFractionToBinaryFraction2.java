/*
*  filename: DecimalFractionToBinaryFraction2.java
*  author: Connor Baker
*  version: 0.1a
...
public class DecimalFractionToBinaryFraction2 {
  ...
  DecimalFractionToBinaryFraction2() {
    initialization();
    queryForAccuracy();
  ...
  public static void main(String[] args) {
    DecimalFractionToBinaryFraction2 newConversion = new DecimalFractionToBinaryFraction2();
  }
}
