/*
*  filename: Base10DecimalToBinary4NonRecursive.java
*  author: Connor Baker
*  version: 0.1a
...
public class Base10DecimalToBinary4NonRecursive {
  ...
  Base10DecimalToBinary4NonRecursive() {
    initialization();
    queryForAccuracy();
  ...
  public void decimalFractionToBinary(BigDecimal decimal) {
    for (numberOfDecimalPlaces = 0; numberOfDecimalPlaces < numberOfFiguresToTrack; numberOfDecimalPlaces += 2) {
  ...
  public static void main(String[] args) {
    Base10DecimalToBinary4NonRecursive newConversion = new Base10DecimalToBinary4NonRecursive();
  }
}
